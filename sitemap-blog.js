...
/*
var toc_config = {
	url: 'https://gagaltotal666.blogspot.com',
	containerId: 'table-of-content',
	showNew: 15,
	newText: '<strong style="font-weight:normal;font-style:normal;color:#fff;font-size:11px;background:#fa0223;padding:1px 6px 3px 6px;line-height:normal;float:right;border-radius:3px;">News</strong>',
	sortAlphabetically: {
		thePanel: true,
		theList: true
	},
